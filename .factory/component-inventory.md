...
These 19 components define the first implementation. Primitive controls are product-shaped and accessible; composites preserve the commercial-chain semantics. Each component needs Storybook-free fixture coverage in Vitest or a route-level Playwright test. Do not build variants that no milestone uses.
