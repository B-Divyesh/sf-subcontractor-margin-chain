# Subcontractor Margin Chain (`subcontractor-margin-chain`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://subcontractor-margin-chain.sociobot.in`. Artifact class: `web-with-backend`.
